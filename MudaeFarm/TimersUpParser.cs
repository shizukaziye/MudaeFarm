...
namespace MudaeFarm
{
    public interface ITimersUpParser { }

    public class TimersUpParser : ITimersUpParser
    {
        ...
        public bool TryParse(IDiscordClient client, IMessage message, out MudaeStateManager state, MudaeStateManager oldState = null)
        {
            ...
            state = oldState?.Clone() ?? new MudaeStateManager();
